...
<server xmlns="urn:jboss:domain:19.0">
    ...
    <profile>
        <subsystem xmlns="urn:jboss:domain:logging:8.0">
            ...
            <logger category="org.jboss.stdio">
                <level name="ERROR"/>
            </logger>
            ...
            <tls>
                <key-stores>
                    <key-store name="applicationKS">
                        <credential-reference clear-text="Coship7000?"/>
                        <implementation type="JKS"/>
                        <file path="coship_pair.jks" relative-to="jboss.server.config.dir"/>
                    </key-store>
                </key-stores>
                <key-managers>
    ...
    <socket-binding-group name="standard-sockets" default-interface="any" port-offset="${jboss.socket.binding.port-offset:8}">
        <!-- <socket-binding name="ajp" port="${jboss.ajp.port:8009}"/> -->
        <socket-binding name="http" port="${jboss.http.port:18888}" fixed-port="true"/>
